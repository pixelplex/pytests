...
class PositiveTesting(BaseTest):
    ...
    def call_get_relative_account_history(self, account, stop, limit, start):
    ...
    def limit_operations_to_retrieve(self, get_random_valid_account_name):
        ...
        response = self.call_get_relative_account_history(new_account, stop, max_limit, start)
        check_that(
            "'number of history results'",
        ...
        response = self.call_get_relative_account_history(new_account, stop, min_limit, start)
        check_that(
            "'number of history results'",
    ...
    def stop_and_start_operations(self, get_random_integer, get_random_integer_up_to_hundred):
        ...
        response = self.call_get_relative_account_history(self.account_1, stop, limit, start)
