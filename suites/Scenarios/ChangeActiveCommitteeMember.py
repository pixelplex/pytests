...
class ChangeActiveCommitteeMember(BaseTest):
    ...
    def get_active_committee_members_eth_addresses(self, active_committee_members_ids=None, print_log=True):
        ...
        committee_members_objs = self.get_response(response_id, log_response=True)["result"]
    ...
    def change_committee_eth_address_scenario(self, get_random_valid_account_name):
        ...
        lcc.log_info("All ECHO active committee members are active in the Ethereum network")
        ...
        old_member_id = set(active_committee_members_ids).difference(set(updated_active_committee_members_ids)).pop()
        new_member_id = set(updated_active_committee_members_ids).difference(set(active_committee_members_ids)).pop()
